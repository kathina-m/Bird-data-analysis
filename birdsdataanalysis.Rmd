...
summary(mod2.2)
anova(mod2.1, mod2.2)
mod2.3 <- update(mod2.2, ~.-canopy_cover)
summary(mod2.3)
anova(mod2.2, mod2.3) 
#mod2.4 <- update(mod2.3, ~.-temperature)
#summary(mod2.4)
#anova(mod2.3,mod2.4)
...
plot(mod2.3) #check for homogeneity of variances (data points should have similar vertical spread along the x-axis)
qqnorm(mod2.3, ~resid(.,type="p"), abline=c(0,1)) #check for normality of residuals (should not be completely off the line)
...
#  geom_text(x=30, y=15, label="p-value: 0.0442", size=3.5) +
