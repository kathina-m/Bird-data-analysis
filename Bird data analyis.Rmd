...
plot(SAC_park, xlab = "Park plots", ylab = "species richness", main="species accumulation curve")
plot(SAC_fore, xlab = "Forest plots", ylab = "species richness", main="species accumulation curve", col="green", add = T)
